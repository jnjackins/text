...
// Package tabwriter is a fork of the standard library
// text/tabwriter, with the following changes: fields that
// can be parsed as numbers are always right-aligned, and everything
// else is always left-aligned. The option to override default alignment
// has been removed.
//
package tabwriter
...
func (b *Writer) writeLines(pos0 int, line0, line1 int) (pos int) {
	...
	for i := line0; i < line1; i++ {
		...
		for j, c := range line {
			...
			cbytes := b.buf.Bytes()[pos : pos+c.size]
			...
			if c.size == 0 {
				...
				// non-empty cell
				useTabs = false
				if isNumber(cbytes) { // align right
					if j < len(b.widths) {
